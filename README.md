...
| 宿舍总压力分析 | V4 已实现 | 基于事件档案内全部记录生成总压力值，并支持 7/15/30/90 天趋势、主要压力来源、情绪分布、事件洞察、推荐场景训练和 AI 心晴见解 |
...
| `/api/events/analysis` | GET | 基于全部事件档案返回宿舍总压力分析，支持 `range_days=7/15/30/90` |
