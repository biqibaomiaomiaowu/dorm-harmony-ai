...
assert(motion.includes('pruneCompletedContexts'), 'useGsapMotion must prune completed contexts')
assert(motion.includes('context.clear'), 'useGsapMotion must clear completed one-shot contexts')
assert(motion.includes('isDisposed'), 'useGsapMotion must guard against animations after unmount')
